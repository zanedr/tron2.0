...
const nextRoundButtonID = document.getElementById('next-round-button');
...
const bikeOneLivesID = document.getElementById('bike-one-lives');
const bikeTwoLivesID = document.getElementById('bike-two-lives');
...
let bikeOne = new Bike(940, 270, 10, 'rgb(223,116,12)', 'left', 3);
