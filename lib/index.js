...
const deathSign = () => {
  ...
  if(stopAnimation1) {
    drawDeath(bikeOne.locationX, bikeOne.locationY);
    console.log(bikeOne.locationX + ' ' + bikeOne.locationY)
  }
  if(stopAnimation2) {
    drawDeath(bikeTwo.locationX, bikeTwo.locationY);
  }
  victoryCheckTimer = setTimeout(victoryCheck, 2000);
}

const drawDeath = (xCoord, yCoord) => {
  context.beginPath();
  context.arc(xCoord, yCoord, 25, 0, 6.28, false)
  context.fillStyle = "rgb(223,135,0)";
  context.fill();
}
