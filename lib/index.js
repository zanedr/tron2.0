...
function animate() {
  ...
  movementBikeOne()
  movementBikeTwo()
  animateLife = bikeOne.youDie(coordinateArray, lives, animation)
  animateLife = bikeTwo.youDie(coordinateArray, lives, animation)
  animation = animateLife.animate
  lifeCounter = animateLife.lives
  console.log(animateLife, 'animateLife')
  console.log(lifeCounter, 'lifeCounter')

  if (lifeCounter === false){
    // console.log('you dead mutha fucka!')
    // nextRound();
    // return 'gameover'
  }
