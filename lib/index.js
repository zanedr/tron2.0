...
var bikeOne = new Bike(950, 275, 10, 'rgb(223,116,12)', 'left', 3);
var bikeTwo = new Bike(50, 275, 10, 'rgb(34,218,222)', 'right', 3);
var counter;
...
function victoryCheck () {
  if(bikeOne.lives === 0) {
      ...
      document.getElementById('final-score').innerText = "Player 2 wins!";
      resetAll();
      return;
  }
  else if(bikeTwo.lives === 0) {
      document.getElementById('victory-screen').style.display = 'block';
      document.getElementById('final-score').innerText = "Player 1 wins!";
      resetAll();
      return;
  }
  else {
